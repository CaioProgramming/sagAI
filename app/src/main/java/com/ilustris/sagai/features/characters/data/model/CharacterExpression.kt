...
enum class CharacterExpression(val description: String) {
    ...
    SURPRISED_WIDE_EYED("Surprised, with wide eyes and perhaps a slightly open mouth"),
    ...
    SCARED_FEARFUL("Looking scared or fearful, eyes wide with apprehension"),
    EXCITED_EAGER("Excited and eager, eyes sparkling with anticipation");

    companion object {
        fun random(): CharacterExpression {
