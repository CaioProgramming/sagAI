...
object CharacterPrompts {
    ...
    fun descriptionTranslationPrompt(
        ...
        genre: Genre,
                                 ...
                                 our goal is to convert the character's description and context below into a single, highly detailed, unambiguous, and visually rich English text description.
                                 ...
                                 OUR SOLE OUTPUT MUST BE THE GENERATED IMAGE PROMPT STRING. DO NOT INCLUDE ANY INTRODUCTORY PHRASES, EXPLANATIONS, RATIONALES, OR CONCLUDING REMARKS. PROVIDE ONLY THE RAW, READY-TO-USE IMAGE PROMPT TEXT.

                                 **Key Instructions for your generated text prompt:**

                                 1.  **Extract, Describe, and Adapt from Visual References**:
                                     our primary role is to act as an expert art director observing the provided **Style Reference Image** and **Composition Reference Image** (which the final image model will also receive as Bitmaps). Your generated text prompt MUST:
                                     ...
                                     *   **From the Composition Reference Image**: Identify and verbally articulate its core compositional features (e.g., 'is it a close-up, medium shot, or full body?', 'what is the camera angle?', 'how is the subject framed or posed?', 'what is the depth of field like?'). If the Composition Reference Image's overall framing isn't a direct portrait (e.g., it's a wider scene), your description must explain how its compositional essence can be effectively **translated and adapted into a compelling Dramatic Character Portrait**.
                                     our goal is to translate the *vibe, style, and compositional cues* of BOTH reference images into a rich textual description. Do not just say 'replicate the references'; instead, *describe WHAT defining characteristics to replicate and adapt* in vivid textual detail.
                                 ...
                                 5.  **Genre Consistency**: Adhere strictly to the theme (${genre.title}). ${
        ImagePrompts.conversionGuidelines(
            genre,
        )
    }
    ...
    fun characterLoreGeneration(
        ...
        characters: List<Character>,
                                 ...
                                 // --- CONTEXT ---
                                 // TimelineContext: ${timeline.toJsonFormatExcludingFields(listOf("id", "emotionalReview", "chapterId"))}

                                 // Characters Context: ${characters.toJsonFormatExcludingFields(
