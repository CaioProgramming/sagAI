...
### Quando gerar um novo post de quarta-feira:

1. **Escolha entre storytelling OU técnico** (não misture demais)
2. **Use exemplos concretos** (antes/depois, cenários reais)
3. **Explique o "porquê técnico"** de forma acessível
4. **Conecte tecnologia com impacto criativo**
5. **Inclua pelo menos 1 diagrama/visual explicativo**

### Hashtags Padrão para Quarta:
`#SagasApp #IANarrativa #TechStory #BastidoresIA #StorytellingTech`

### Tom de Voz:
- ❌ Evitar: Jargão excessivo, explicações rasas, foco só em tech
- ✅ Buscar: Curiosidade, admiração pela tecnologia, conexão emocional

---

## Estruturas Narrativas Efetivas

### Para posts técnicos:
1. Cenário de uso
2. Problema que resolve
3. Como funciona (simplificado)
4. Impacto para o usuário
5. Convite para testar

### Para posts de storytelling:
1. Mini-história ou exemplo
2. Como o app possibilita isso
3. Detalhes do sistema narrativo
4. Comparação com outras soluções
5. Convite para criar

---

## Exemplos de Hooks Narrativos

- "Capítulo 47. Você menciona..."
- "Imagine escrever 'Estou com medo' e a IA..."
- "Três palavras simples. Mas a IA lê..."
- "Não é apenas [coisa comum]. É [coisa profunda]."
- "Cada [elemento] no Sagas não é apenas..."
- "Você escreve X. A IA entende Y."

---

## Checklist Antes de Publicar

- [ ] Caption tem 200-300 palavras?
- [ ] Inclui exemplo concreto de uso?
- [ ] Explica pelo menos 1 aspecto técnico?
- [ ] Conecta tech com impacto criativo?
- [ ] Tem diagrama ou visual explicativo?
- [ ] 5-6 hashtags relevantes?
- [ ] Tom equilibra técnico e narrativo?
