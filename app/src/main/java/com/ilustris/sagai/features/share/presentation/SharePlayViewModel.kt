...
class SharePlayViewModel
    ...
    constructor(
        ...
        val sagaContent = MutableStateFlow<SagaContent?>(null)
        ...
        fun generateShareText(
            ...
            viewModelScope.launch(Dispatchers.IO) {
                ...
                val sagaFullContent = sagaHistoryUseCase.getSagaById(saga.id).first() ?: return@launch
                sagaContent.emit(sagaFullContent)
                sharePlayUseCase
                    .generateShareMessage(saga, shareType, character)
                    .onSuccess {
                        shareText.value = it
