...
import com.ilustris.sagai.features.saga.chat.domain.usecase.model.SuggestionGen
...
object SuggestionPrompts {
    fun generateSuggestionsPrompt(
        ...
        val historyFormatted = chatHistory.joinToString { it.joinMessage(true).formatToString() }
